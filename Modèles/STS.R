...
## slope = 2.087e+08 : Une variance plus faible, que celle précédente, suggère que la tendance est relativement stable.
...
## autour du niveau moyen et des variations saisonnières ainsi que celle des résidus. La pente
